...
import com.high.pi_service.utils.V8Executor;
import com.high.pi_service.utils.V8Map;
import com.high.pi_service.utils.V8Runnable;
...
public class V8 extends V8Object {
    ...
    private static void checkNativeLibraryLoaded() {
        if (!nativeLibraryLoaded) {
            String message = "piv8 native library not loaded!";
