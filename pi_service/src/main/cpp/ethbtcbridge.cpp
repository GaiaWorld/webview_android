...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1eth_1from_1mnemonic(JNIEnv *env, jobject, jstring mneonic, jstring language, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1eth_1generate(JNIEnv *env, jobject, jint strength, jstring language, jobjectArray oa){
    const char *ltr = env->GetStringUTFChars(language, 0);
    char *address;
    char *priv_key;
    char *master_seed;
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1eth_1select_1wallet(JNIEnv *env, jobject, jstring language, jstring master_seed, jint index, jobjectArray oa) {
    const char *ltr = env->GetStringUTFChars(language, 0);
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1eth_1sign_1raw_1transaction(JNIEnv *env, jobject, jint chain_id, jstring nonce, jstring to, jstring value, jstring gas, jstring gas_price, jstring data, jstring priv_key, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1get_1public_1key_1by_1mnemonic(JNIEnv *env, jobject, jstring mnemonic, jstring language, jobjectArray oa){
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1token_1balance_1call_1data(JNIEnv *env, jobject, jstring addr){
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1token_1transfer_1call_1data(JNIEnv *env, jobject, jstring addr_to, jstring value){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1btc_1build_1raw_1transaction_1from_1single_1address(JNIEnv *env, jobject, jstring address, jstring priv_key, jstring input, jstring output, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1btc_1from_1mnemonic(JNIEnv *env, jobject, jstring mnemonic, jstring network, jstring language, jstring pass_phrase, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1btc_1from_1seed(JNIEnv *env, jobject, jstring seed, jstring network, jstring language, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1btc_1generate(JNIEnv *env, jobject, jint strength, jstring network, jstring language, jstring pass_phrase, jobjectArray oa){
    const char *priv_keystr = env->GetStringUTFChars(network, 0);
    const char *inputstr = env->GetStringUTFChars(language, 0);
    const char *outputstr = env->GetStringUTFChars(pass_phrase, 0);
    char *root_xpriv;
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1btc_1private_1key_1of(JNIEnv *env, jobject, jint index, jstring root_xpriv, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1btc_1to_1address(JNIEnv *env, jobject, jstring network, jstring priv_key, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1btc_1build_1pay_1to_1pub_1key_1hash(JNIEnv *env, jobject, jstring address, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1rust_1decrypt(JNIEnv *env, jobject, jstring key, jstring nonce, jstring aad, jstring cipher_text, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1rust_1encrypt(JNIEnv *env, jobject, jstring key, jstring nonce, jstring aad, jstring plain_text, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1rust_1sha256(JNIEnv *env, jobject, jstring data, jobjectArray oa){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_utils_PiEthBtcWrapper__1rust_1sign(JNIEnv *env, jobject, jstring priv_key, jstring msg, jobjectArray oa){
