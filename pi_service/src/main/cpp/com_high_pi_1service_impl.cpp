...
#include <iostream>
#include "com_high_pi_1service_impl.h"
...
bool isNumber(int type) {
    return type == com_v8_V8_DOUBLE || type == com_v8_V8_INTEGER;
}

bool isObject(int type) {
    return type == com_v8_V8_V8_OBJECT || type == com_v8_V8_V8_ARRAY;
}
...
int getType(Handle<Value> v8Value) {
    if (v8Value.IsEmpty() || v8Value->IsUndefined()) {
        return com_v8_V8_UNDEFINED;
    }
    else if (v8Value->IsNull()) {
        return com_v8_V8_NULL;
    }
    else if (v8Value->IsInt32()) {
        return com_v8_V8_INTEGER;
    }
    else if (v8Value->IsNumber()) {
        return com_v8_V8_DOUBLE;
    }
    else if (v8Value->IsBoolean()) {
        return com_v8_V8_BOOLEAN;
    }
    else if (v8Value->IsString()) {
        return com_v8_V8_STRING;
    }
    else if (v8Value->IsFunction()) {
        return com_v8_V8_V8_FUNCTION;
    }
    else if (v8Value->IsArrayBuffer()) {
        return com_v8_V8_V8_ARRAY_BUFFER;
    }
    else if (v8Value->IsTypedArray()) {
        return com_v8_V8_V8_TYPED_ARRAY;
    }
    else if (v8Value->IsArray()) {
        return com_v8_V8_V8_ARRAY;
    }
    else if (v8Value->IsObject()) {
        return com_v8_V8_V8_OBJECT;
    }
    return -1;
}
...
void voidCallback(const FunctionCallbackInfo<Value>& args) {
    ...
    jobject jreceiver = getResult(env, v8, md->v8RuntimePtr, isolate, receiver, com_v8_V8_UNKNOWN);
...
void objectCallback(const FunctionCallbackInfo<Value>& args) {
    ...
    if (env->ExceptionCheck()) {
        ...
        else if (returnType == com_v8_V8_V8_ARRAY) {
        ...
        else if (returnType == com_v8_V8_V8_OBJECT) {
            if (isUndefined(env, resultObject)) {
                args.GetReturnValue().SetUndefined();
            }
            else {
        ...
        else if (returnType == com_v8_V8_V8_ARRAY_BUFFER) {
            if (isUndefined(env, resultObject)) {
                args.GetReturnValue().SetUndefined();
            }
            else {
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8Object(JNIEnv *env, jobject, jlong v8RuntimePtr){
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initEmptyContainer(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Persistent<Object>* container = new Persistent<Object>;
    return reinterpret_cast<jlong>(container);
}

JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1acquireLock(JNIEnv *env, jobject, jlong v8RuntimePtr){
    V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1releaseLock(JNIEnv *env, jobject, jlong v8RuntimePtr){
    V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
    if(runtime->isolate->InContext()) {
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1lowMemoryNotification(JNIEnv *env, jobject, jlong v8RuntimePtr){
    V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
    runtime->isolate->LowMemoryNotification();
}

JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1createTwin(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong twinObjectHandle){
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1releaseRuntime(JNIEnv *env, jobject, jlong v8RuntimePtr) {
    if (v8RuntimePtr == 0) {
        return;
    }
    Isolate* isolate = getIsolate(env, v8RuntimePtr);
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1createIsolate(JNIEnv *env, jobject v8, jstring globalAlias){
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1executeIntegerScript(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    TryCatch tryCatch(isolate);
    Local<Script> script;
    Local<Value> result;
...
JNIEXPORT jdouble JNICALL Java_com_high_pi_1service_V8__1executeDoubleScript(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    TryCatch tryCatch(isolate);
    Local<Script> script;
    Local<Value> result;
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_V8__1executeStringScript(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
...
JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1executeBooleanScript(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
...
JNIEXPORT jobject JNICALL Java_com_high_pi_1service_V8__1executeScript(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    TryCatch tryCatch(isolate);
    Local<Script> script;
    Local<Value> result;
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1executeVoidScript(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    TryCatch tryCatch(isolate);
    Local<Script> script;
    if (!compileScript(isolate, jjstring, env, jscriptName, jlineNumber, script, &tryCatch))
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1release(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    if (v8RuntimePtr == 0) {
        return;
    }
    Isolate* isolate = getIsolate(env, v8RuntimePtr);
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1releaseMethodDescriptor(JNIEnv *, jobject, jlong, jlong methodDescriptorPtr) {
    MethodDescriptor* md = reinterpret_cast<MethodDescriptor*>(methodDescriptorPtr);
    delete(md);
}


JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1contains(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    Local<String> v8Key = createV8String(env, isolate, key);
...
JNIEXPORT jobjectArray JNICALL Java_com_high_pi_1service_V8__1getKeys(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1getInteger(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1getBoolean(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
    ASSERT_IS_BOOLEAN(v8Value);
...
JNIEXPORT jdouble JNICALL Java_com_high_pi_1service_V8__1getDouble(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
    ASSERT_IS_NUMBER(v8Value);
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_V8__1getString(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
    ASSERT_IS_STRING(v8Value);
...
JNIEXPORT jobject JNICALL Java_com_high_pi_1service_V8__1get(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1executeIntegerFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> result;
...
JNIEXPORT jdouble JNICALL Java_com_high_pi_1service_V8__1executeDoubleFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return 0;
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_V8__1executeStringFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return NULL;
...
JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1executeBooleanFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return false;
...
JNIEXPORT jobject JNICALL Java_com_high_pi_1service_V8__1executeFunction__JIJLjava_lang_String_2J(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return NULL;
...
JNIEXPORT jobject JNICALL Java_com_high_pi_1service_V8__1executeFunction__JJJJ(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong receiverHandle, jlong functionHandle, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, receiverHandle, functionHandle, parameterHandle, result))
        return NULL;
    return getResult(env, v8, v8RuntimePtr, isolate, result, com_v8_V8_UNKNOWN);
}


JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1executeVoidFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Value> result;
...
JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1equals(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_V8__1toString(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1strictEquals(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1sameValue(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    Handle<Object> that = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    if (objectHandle == reinterpret_cast<jlong>(runtime->globalObject)) {
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1identityHash(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    if (objectHandle == reinterpret_cast<jlong>(runtime->globalObject)) {
        object = context->Global();
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1add__JJLjava_lang_String_2I(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jint value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Int32::New(isolate, value));
}


JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addObject(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jlong valueHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1add__JJLjava_lang_String_2Z(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jboolean value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Boolean::New(isolate, value));
}


JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1add__JJLjava_lang_String_2D(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jdouble value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Number::New(isolate, value));
}


JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1add__JJLjava_lang_String_2Ljava_lang_String_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jstring value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addUndefined(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Undefined(isolate));
}


JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addNull(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Null(isolate));
}


JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1registerJavaMethod(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring functionName, jboolean voidMethod) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8Array(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlongArray JNICALL Java_com_high_pi_1service_V8__1initNewV8Function(JNIEnv *env, jobject, jlong v8RuntimePtr) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    MethodDescriptor* md = new MethodDescriptor();
    Local<External> ext = External::New(isolate, md);
    Persistent<External> pext(isolate, ext);
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1arrayGetSize(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1arrayGetInteger(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1arrayGetBoolean(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_BOOLEAN(v8Value);
...
JNIEXPORT jbyte JNICALL Java_com_high_pi_1service_V8__1arrayGetByte(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_NUMBER(v8Value);
...
JNIEXPORT jdouble JNICALL Java_com_high_pi_1service_V8__1arrayGetDouble(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_NUMBER(v8Value);
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_V8__1arrayGetString(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_STRING(v8Value);
...
JNIEXPORT jobject JNICALL Java_com_high_pi_1service_V8__1arrayGet(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addArrayIntItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addArrayBooleanItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jboolean value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addArrayDoubleItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jdouble value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addArrayStringItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jstring value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addArrayObjectItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jlong valueHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addArrayUndefinedItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1addArrayNullItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1getType__JJLjava_lang_String_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1getType__JJI(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1getArrayType(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    int length = 0;
    if ( array->IsTypedArray() ) {
        if ( array->IsFloat64Array() ) {
            ...
            return com_v8_V8_FLOAT_32_ARRAY;
        } else if ( array->IsInt32Array() ) {
            return com_v8_V8_INT_32_ARRAY;
        } else if ( array->IsUint32Array() ) {
            return com_v8_V8_UNSIGNED_INT_32_ARRAY;
        } else if ( array->IsInt16Array() ) {
            return com_v8_V8_INT_16_ARRAY;
        } else if ( array->IsUint16Array() ) {
            return com_v8_V8_UNSIGNED_INT_16_ARRAY;
        } else if ( array->IsInt8Array() ) {
            return com_v8_V8_INT_8_ARRAY;
        } else if ( array->IsUint8Array() ) {
            return com_v8_V8_UNSIGNED_INT_8_ARRAY;
        } else if ( array->IsUint8ClampedArray() ) {
            return com_v8_V8_UNSIGNED_INT_8_CLAMPED_ARRAY;
        }
        return com_v8_V8_INTEGER;
    } else {
        length = Array::Cast(*array)->Length();
    }
    int arrayType = com_v8_V8_UNDEFINED;
    for (int index = 0; index < length; index++) {
        ...
        if (type < 0) {
            ...
            arrayType = com_v8_V8_DOUBLE;
        }
        else if (isObject(arrayType, type)) {
            arrayType = com_v8_V8_V8_OBJECT;
        }
        else {
            return com_v8_V8_UNDEFINED;
        }
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1setPrototype(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong prototypeHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_V8__1getConstructorName(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1getType__JJ(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1getType__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    int result = -1;
    for (int i = start; i < start + length; i++) {
...
JNIEXPORT jdoubleArray JNICALL Java_com_high_pi_1service_V8__1arrayGetDoubles__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jintArray JNICALL Java_com_high_pi_1service_V8__1arrayGetIntegers__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jbooleanArray JNICALL Java_com_high_pi_1service_V8__1arrayGetBooleans__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jbyteArray JNICALL Java_com_high_pi_1service_V8__1arrayGetBytes__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1arrayGetDoubles__JJIILdouble_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jdoubleArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1arrayGetIntegers__JJIILint_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jintArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jobjectArray JNICALL Java_com_high_pi_1service_V8__1arrayGetStrings__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1arrayGetBooleans__JJIILboolean_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jbooleanArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1arrayGetBytes__JJIILbyte_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jbyteArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_high_pi_1service_V8__1arrayGetStrings__JJIILjava_lang_String_3_093_2(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jobjectArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8ArrayBuffer__JI(JNIEnv *env, jobject, jlong v8RuntimePtr, jint capacity) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8ArrayBuffer__JLjava_nio_ByteBuffer_2I(JNIEnv *env, jobject, jlong v8RuntimePtr, jobject byteBuffer, jint capacity) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8Int32Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8UInt32Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8Float32Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8Float64Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8Int16Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8UInt16Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8Int8Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8UInt8Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1initNewV8UInt8ClampedArray(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1setWeak(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1clearWeak(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    reinterpret_cast<Persistent<Object>*>(objectHandle)->ClearWeak();
}


JNIEXPORT jboolean JNICALL Java_com_high_pi_1service_V8__1isWeak(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    return reinterpret_cast<Persistent<Object>*>(objectHandle)->IsWeak();
}


JNIEXPORT jobject JNICALL Java_com_high_pi_1service_V8__1createV8ArrayBufferBackingStore(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jint capacity) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jstring JNICALL Java_com_high_pi_1service_V8__1getVersion(JNIEnv *env, jclass){
    const char *utfstring = v8::V8::GetVersion();
    return env->NewStringUTF(utfstring);
}

JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1setFlags(JNIEnv *env, jclass, jstring v8flags){
    if (v8flags) {
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1terminateExecution(JNIEnv * env, jobject, jlong v8RuntimePtr) {
    if (v8RuntimePtr == 0) {
        return;
    }
    Isolate* isolate = getIsolate(env, v8RuntimePtr);
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1getGlobalObject(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_high_pi_1service_V8__1getBuildID(JNIEnv *, jobject) {
    return 1;
}
...
jobject getResult(JNIEnv *env, jobject &v8, jlong v8RuntimePtr, Isolate* isolate, Handle<Value> &result, jint expectedType) {
    ...
    if (result->IsUndefined() && expectedType == com_v8_V8_V8_ARRAY) {
        jobject objectResult = env->NewObject(undefinedV8ArrayCls, undefinedV8ArrayInitMethodID, v8);
        return objectResult;
    }
    else if (result->IsUndefined() && (expectedType == com_v8_V8_V8_OBJECT || expectedType == com_v8_V8_NULL)) {
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1connect(JNIEnv *env, jobject, jlong v8RuntimePtr, jobject connection){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
    piv8_inspector::getInstance()->connect(env,connection);
}


JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1disconnect(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
    piv8_inspector::getInstance()->disconnect(env,isolate);
}


JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1dispatchMessage(JNIEnv *env, jobject, jlong v8RuntimePtr,jstring message){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
...
JNIEXPORT void JNICALL Java_com_high_pi_1service_V8__1initDebugger(JNIEnv *env, jobject , jlong v8RuntimePtr){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
