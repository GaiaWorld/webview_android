...
const parser_1 = require("../compile/parser");
const reader_1 = require("../compile/reader");
const scanner_1 = require("../compile/scanner");
// TEXT 文本状态 0
// 文本态无法直接切换到htmlAttr和htmlstr态,只能切换到另外3个状态
// 测试初始化
exports.parserTpl = (tpl, filename, errFunc) => {
    const reader = reader_1.createByStr(tpl);
