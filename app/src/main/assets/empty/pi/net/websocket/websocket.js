...
const protocol_block_1 = require("./protocol_block");
    ...
    create(url, con, cfg) {
        ...
        ws.onmessage = (evt) => {
            ...
            if (util_1.isString(evt.data)) {
                ...
                this.encodeEncryption = protocol_block_1.getEncryption(preEncode);
                this.decodeEncryption = protocol_block_1.getEncryption(preDecode);
            }
                ...
                // console.log(b)
                if (this.mEncode) {
                    newEncryption = protocol_block_1.nextEncryption(this.decodeEncryption);
                }
        ...
        ws.getEncodeEncryption = () => {
            return protocol_block_1.nextEncryption(this.encodeEncryption);
        };
        ws.setEncodeEncryption = (encryption) => {
