...
exports.create = () => {
     ...
     * @example
     */
    frame.setStat = (callback, interval) => {
...
// 获取raf函数，处理兼容性
const requestFrameImpl = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || normalrRequestFrameImpl;
// tslint:disable:no-unnecessary-callback-wrapper
exports.requestFrame = callBack => requestFrameImpl(callBack);
// 获取raf取消函数，处理兼容性
...
exports.cancelFrame = callBack => cancelFrameImpl(callBack);
// ============================== 本地
// 全局帧管理器
let mgr;
// 函数调用
