...
exports.VARNAME = '_cfg, it, it1, it2, it3, it4, it5, it6, it7, it8, it9';
...
exports.installText = (value, hash) => {
    const node = {
        text: value,
        childHash: hash,
        hash: hash,
...
exports.toFun = (s, path) => {
    try {
        ...
        return (new Function(exports.stringifyName, exports.getName, exports.hashName, exports.pathName, exports.convertEntityName, exports.calAttrHashName, exports.calTextHashName, exports.addJsonName, exports.installTextName, exports.addTextName, exports.chFuncName, 'return' + s))(exports.toString, mod_1.commonjs ?
            mod_1.commonjs.relativeGet : null, hash, path, exports.convertEntity, exports.calAttrHash, exports.calTextHash, exports.addJson, exports.installText, exports.addText, exports.chFunc);
    }
    catch (e) {
...
exports.toFunComplete = (func, path) => {
    try {
        return func(exports.toString, mod_1.commonjs ? mod_1.commonjs.relativeGet : null, hash, path, exports.convertEntity, exports.calAttrHash, exports.calTextHash, exports.addJson, exports.installText, exports.addText, exports.chFunc);
    }
    catch (e) {
        log_1.warn(exports.level, 'tpl toFun, path: ' + path + ',' + e);
        throw (e);
    }
};
/**
