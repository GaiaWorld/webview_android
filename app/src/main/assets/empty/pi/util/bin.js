 ...
 * @example
 */
exports.writeContainer = (o, bb, writeNext) => {
    if (Array.isArray(o)) {
 ...
 * @example
 */
exports.readContainer = (bb, len, type, readNext) => {
    switch (type) {
        case 1:
