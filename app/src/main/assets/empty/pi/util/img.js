 ...
 * @example
 */
exports.filter = (data, width, height, args) => {
 ...
 * @example
 */
exports.gray = (data, width, height) => {
 ...
 * @example
 */
exports.hsl = (data, width, height, hue, saturate, lightness) => {
    hue = hue || 180;
    saturate = saturate || 1;
 ...
 * @example
 */
exports.brightnessContrast = (data, width, height, brightness, contrast) => {
 ...
 * @example
 */
exports.corrode = (data, width, height, radius) => {
 ...
 * @example
 */
exports.sharp = (data, width, height, lamta) => {
    lamta = lamta || 3;
    for (let i = 0, n = data.length; i < n; i += 4) {
        const ii = i / 4;
 ...
 * @example
 */
exports.gaussBlur = (data, width, height, radius, sigma) => {
    const gaussMatrix = [];
    let gaussSum = 0;
    let x;
    let y;
...
const toPng = (data, width, height) => {
    ...
    let crc = hash_1.getCrc32(u8, HEADChunk.byteLength + 4, offset - 4); // IHDR crc
...
const writePngData = (src, dest, len, width, result) => {
