 ...
 * @example
 */
exports.calcHashTime = (s, limitTime) => {
    let t = time_1.now();
 ...
 * @example
 */
exports.charHashIgnoreCase = (hash, char) => {
 ...
 * @example
 */
exports.charHashIgnoreWhiteSpace = (hash, char) => {
    const c = char.charCodeAt(0);
 ...
 * @example
 */
exports.charHashIgnoreCaseIgnoreWhiteSpace = (hash, char) => {
    const c = char.charCodeAt(0);
 ...
 * @example
 */
exports.iterHashCode = (arr, h, fun) => {
    h = h || 0;
 ...
 * @example
 */
exports.objHashCode = (obj, h, cycleObjSet) => {
    for (const k in obj) {
 ...
 * @example
 */
exports.arrHashCode = (arr, h, cycleObjSet) => {
    for (const v of arr) {
...
exports.anyHash = (obj, h, cycleObjSet) => {
    if (obj === undefined) {
 ...
 */
// tslint:disable-next-line:cyclomatic-complexity
exports.deepCopyHash = (obj, result, key, h) => {
    if (obj === undefined) {
        result[key] = obj;
        return exports.nextHash(h || 0, 1);
    }
 ...
 * @example
 */
exports.getCrc32 = (data, start, end) => {
 ...
 * @example
 */
exports.crc32 = (data, start, end, crc) => {
    while (start < end) {
 ...
 * @example
 */
exports.adler32 = (data, start, end, adler) => {
    const BASE = 65521;
    const NMAX = 5552;
    let s1 = adler & 0xffff;
...
exports.murmurhash3_32 = (key, seed) => {
    let k;
 ...
 */
// tslint:disable-next-line:variable-name
exports.murmurhash3_32s = (key, seed) => {
    let c;
    let cc;
    let k;
    const remainder = key.length & 3; // key.length % 4
 ...
 */
// tslint:disable-next-line:variable-name
exports.murmurhash3_32i = (k, seed) => {
    const c1 = 0xcc9e2d51;
    const c2 = 0x1b873593;
...
exports.weak32 = (data, prev, start, end) => {
    let a = 0;
    let b = 0;
    const sum = 0;
    const M = 1 << 16;
