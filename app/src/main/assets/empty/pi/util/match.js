 ...
 * @example
 */
exports.eleIndex = (i, arr, start, end, equal) => {
    for (; start < end; start++) {
 ...
 * @example
 */
exports.matchEqual = (arr1, offset1, arr2, offset2, len, equal) => {
 ...
 * @example
 */
exports.arrayIndex = (arr1, start1, end1, arr2, start2, end2, equal, hash) => {
 ...
 * @example
 */
exports.matchPrefix = (arr1, start1, end1, arr2, start2, end2, equal) => {
    let min;
    let max;
    let mid;
    let offset;
 ...
 * @example
 */
exports.matchSuffix = (arr1, start1, end1, arr2, start2, end2, equal) => {
    let min;
    let max;
    let mid;
    let offset;
 ...
 * @example
 */
const halfMatch1 = (arr1, start1, end1, arr2, start2, end2, equal, hash, i, result, ri) => {
 ...
 * @example
 */
exports.halfMatch = (arr1, start1, end1, arr2, start2, end2, equal, hash, result) => {
    let j;
 ...
 * @example
 */
const bisectSplit = (arr1, start1, end1, arr2, start2, end2, equal, hash, result, x, y) => {
    temp_v1.length = 0;
    temp_v2.length = 0;
...
const matchBisect = (arr1, start1, end1, arr2, start2, end2, equal, hash, result) => {
    let x1;
    let y1;
    let x2;
    let y2;
 ...
 * @example
 */
const matchCompute = (arr1, start1, end1, arr2, start2, end2, equal, hash, result) => {
    let s1;
    let e1;
    let s2;
    let e2;
 ...
 * @example
 */
exports.matchMain = (arr1, start1, end1, arr2, start2, end2, equal, hash, result) => {
    if (start1 >= end1 || start2 >= end2)
        return;
    let len = exports.matchPrefix(arr1, start1, end1, arr2, start2, end2, equal);
    if (len > 0) {
 ...
 * @example
 */
exports.match = (arr1, arr2, equal, hash, result) => {
    if (!arr1) {
