_$define("pi/util/math", function (require, exports, module){
"use strict";
/**
 * 数学库
 */
 ...
 */
exports.strip = (num, precision = 12) => {
 ...
 *
 */
exports.cryptoRandomInts = (array) => {
    if (crypto) {
 ...
 * @example
 */
exports.getDirection = (vx1, vy1, vx2, vy2) => {
 ...
 * @example
 */
exports.getAngle = (vx1, vy1, vx2, vy2) => {
 ...
 * @example
 */
exports.bernstein = (i, n) => {
    return exports.factorial(n) / exports.factorial(i) / exports.factorial(n - i);
};
/**
 * @description Catmull-Rom 样条插值 interpolation
 * @example
 */
exports.catmullRom = (t, p0, p1, p2, p3) => {
    const v0 = (p2 - p0) * 0.5;
    const v1 = (p3 - p1) * 0.5;
    const t2 = t * t;
    const t3 = t * t2;
 ...
 * @description 5次平滑插值
 */
exports.smootherstep = (x, min, max) => {
    if (x <= min)
        return 0;
    if (x >= max)
        return 1;
 ...
 * @description 角度转弧度
 */
exports.degreeToRadian = (degrees) => {
 ...
 * @description 弧度转角度
 */
exports.radianToDegree = (radians) => {
 ...
 * @description 是否为二的冥
 */
exports.isPowerOfTwo = (value) => {
    return (value & (value - 1)) === 0 && value !== 0;
};
/**
 * @description 最近的2的冥的整数
 */
exports.nearestPowerOfTwo = (value) => {
    return Math.pow(2, Math.round(Math.log(value) / Math.LN2));
};
/**
 * @description 下一个2的冥的数
 */
exports.nextPowerOfTwo = (value) => {
    --value;
    value |= value >> 1;
    value |= value >> 2;
    value |= value >> 4;
