_$define("app/pi_sdk/sdkTools", function (require, exports, module){
"use strict";
/**
 * sdk tools
 */
 ...
 */
// tslint:disable-next-line:max-func-body-length
exports.createThirdApiStyleTag = () => {
    const cssText = `
    .pi-mask {
    position: absolute;
    top: 0;
...
// --------创建标签----------------------------------------------------------------------------------------------------------------------------
// 创建授权弹窗标签
exports.createAuthorizeElementTag = () => {
    const htmlText = `
...
exports.createPayElementTag = () => {
    ...
    const $body = document.querySelector('.pi-root');
    $body.appendChild($root);
    $body.style.display = 'flex';
};
// 创建加载弹窗标签
exports.popNewLoading = (loadingStr) => {
    const htmlText = `
 ...
 * 密码弹框
 */
exports.popInputBox = (title, okCB, cancelCB) => {
...
const dragDom = (element, callback) => {
    ...
    document.ontouchmove = (event) => {
        ...
        if (params.flag) {
            ...
            // tslint:disable-next-line:one-variable-per-declaration
            let nowLeft = parseInt(params.left, 10) + disX, nowTop = parseInt(params.top, 10) + disY;
