//!version=1.GA1zFFBrXr9heZs1RymcU1.42.100944
...
winit.path = "/vm/"; //"/pi/0.1/";

winit.loadJS(winit.getLoadDomain("vminit.js",winit.path + 'pi/boot/vminit.js'));

winit.loadJS(winit.getLoadDomain("vmnext.js",winit.path + 'boot/vmnext.js'));
...
winit.loadJS(winit.getLoadDomain(dependFile,winit.path + dependFile));
