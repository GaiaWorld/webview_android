...
winit.loadJS(winit.getLoadDomain("next.js"),
	winit.path + 'boot/next.js?' + Math.random(), "utf8", winit.initFail, "load next error");
...
winit.loadJS(winit.getLoadDomain(dependFile), 
	winit.path + dependFile + '?' + Math.random(), "utf8", winit.initFail, "load list error");
