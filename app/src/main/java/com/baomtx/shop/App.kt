...
//        MiPushRegister.register(applicationContext, "2882303761517862496", "5611786234496");
        OppoRegister.register(applicationContext,"cb365fc8e4e0456cb212a27ba0bf2486","49ff96e0774844cca8ed8c652f45ed0d")
        // 注册方法会自动判断是否支持华为系统推送，如不支持会跳过注册。
        HuaWeiRegister.register(applicationContext);
        pushService.register(applicationContext, "27738854","6e63bb84aca9a968a144d205a32bb65b",object : CommonCallback {
