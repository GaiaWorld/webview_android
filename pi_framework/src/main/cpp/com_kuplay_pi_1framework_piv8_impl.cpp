...
#include <iostream>
#include "com_kuplay_pi_1framework_piv8_impl.h"
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jvm = vm;
    v8cls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8"));
    v8ObjectCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8Object"));
    v8ArrayCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8Array"));
    v8TypedArrayCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8TypedArray"));
    v8ArrayBufferCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8ArrayBuffer"));
    v8FunctionCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8Function"));
    undefinedV8ObjectCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8Object$Undefined"));
    undefinedV8ArrayCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8Array$Undefined"));
    ...
    v8ResultsUndefinedCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8ResultUndefined"));
    v8ScriptCompilationCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8ScriptCompilationException"));
    v8ScriptExecutionException = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8ScriptExecutionException"));
    v8RuntimeExceptionCls = (jclass)env->NewGlobalRef((env)->FindClass("com/kuplay/pi_framework/piv8/V8RuntimeException"));
    ...
    v8ArrayInitMethodID = env->GetMethodID(v8ArrayCls, "<init>", "(Lcom/kuplay/pi_framework/piv8/V8;)V");
    v8TypedArrayInitMethodID = env->GetMethodID(v8TypedArrayCls, "<init>", "(Lcom/kuplay/pi_framework/piv8/V8;)V");
    v8ArrayBufferInitMethodID = env->GetMethodID(v8ArrayBufferCls, "<init>", "(Lcom/kuplay/pi_framework/piv8/V8;Ljava/nio/ByteBuffer;)V");
    v8ArrayGetHandleMethodID = env->GetMethodID(v8ArrayCls, "getHandle", "()J");
    v8CallVoidMethodID = (env)->GetMethodID(v8cls, "callVoidJavaMethod", "(JLcom/kuplay/pi_framework/piv8/V8Object;Lcom/kuplay/pi_framework/piv8/V8Array;)V");
    ...
    v8CallObjectJavaMethodMethodID = (env)->GetMethodID(v8cls, "callObjectJavaMethod", "(JLcom/kuplay/pi_framework/piv8/V8Object;Lcom/kuplay/pi_framework/piv8/V8Array;)Ljava/lang/Object;");
    ...
    v8FunctionInitMethodID = env->GetMethodID(v8FunctionCls, "<init>", "(Lcom/kuplay/pi_framework/piv8/V8;)V");
    v8ObjectInitMethodID = env->GetMethodID(v8ObjectCls, "<init>", "(Lcom/kuplay/pi_framework/piv8/V8;)V");
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Object(JNIEnv *env, jobject, jlong v8RuntimePtr){
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initEmptyContainer(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Persistent<Object>* container = new Persistent<Object>;
    return reinterpret_cast<jlong>(container);
}

JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1acquireLock(JNIEnv *env, jobject, jlong v8RuntimePtr){
    V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1releaseLock(JNIEnv *env, jobject, jlong v8RuntimePtr){
    V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
    if(runtime->isolate->InContext()) {
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1lowMemoryNotification(JNIEnv *env, jobject, jlong v8RuntimePtr){
    V8Runtime* runtime = reinterpret_cast<V8Runtime*>(v8RuntimePtr);
    runtime->isolate->LowMemoryNotification();
}

JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1createTwin(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong twinObjectHandle){
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1releaseRuntime(JNIEnv *env, jobject, jlong v8RuntimePtr) {
    if (v8RuntimePtr == 0) {
        return;
    }
    Isolate* isolate = getIsolate(env, v8RuntimePtr);
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1createIsolate(JNIEnv *env, jobject v8, jstring globalAlias){
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeIntegerScript(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    TryCatch tryCatch(isolate);
    Local<Script> script;
    Local<Value> result;
...
JNIEXPORT jdouble JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeDoubleScript(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    TryCatch tryCatch(isolate);
    Local<Script> script;
    Local<Value> result;
...
JNIEXPORT jstring JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeStringScript(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
...
JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeBooleanScript(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
...
JNIEXPORT jobject JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeScript(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    TryCatch tryCatch(isolate);
    Local<Script> script;
    Local<Value> result;
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeVoidScript(JNIEnv * env, jobject v8, jlong v8RuntimePtr, jstring jjstring, jstring jscriptName = NULL, jint jlineNumber = 0) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    TryCatch tryCatch(isolate);
    Local<Script> script;
    if (!compileScript(isolate, jjstring, env, jscriptName, jlineNumber, script, &tryCatch))
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1release(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    if (v8RuntimePtr == 0) {
        return;
    }
    Isolate* isolate = getIsolate(env, v8RuntimePtr);
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1releaseMethodDescriptor(JNIEnv *, jobject, jlong, jlong methodDescriptorPtr) {
    MethodDescriptor* md = reinterpret_cast<MethodDescriptor*>(methodDescriptorPtr);
    delete(md);
}


JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1contains(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    Local<String> v8Key = createV8String(env, isolate, key);
...
JNIEXPORT jobjectArray JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getKeys(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getInteger(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getBoolean(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
    ASSERT_IS_BOOLEAN(v8Value);
...
JNIEXPORT jdouble JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getDouble(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
    ASSERT_IS_NUMBER(v8Value);
...
JNIEXPORT jstring JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getString(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
    ASSERT_IS_STRING(v8Value);
...
JNIEXPORT jobject JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1get(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeIntegerFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> result;
...
JNIEXPORT jdouble JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeDoubleFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return 0;
...
JNIEXPORT jstring JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeStringFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return NULL;
...
JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeBooleanFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return false;
...
JNIEXPORT jobject JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeFunction__JIJLjava_lang_String_2J(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Value> result;
    if (!invokeFunction(env, isolate, v8RuntimePtr, objectHandle, jfunctionName, parameterHandle, result))
        return NULL;
...
JNIEXPORT jobject JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeFunction__JJJJ(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong receiverHandle, jlong functionHandle, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Value> result;
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1executeVoidFunction(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jlong objectHandle, jstring jfunctionName, jlong parameterHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Value> result;
...
JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1equals(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jstring JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1toString(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1strictEquals(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1sameValue(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong thatHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    Handle<Object> that = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    if (objectHandle == reinterpret_cast<jlong>(runtime->globalObject)) {
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1identityHash(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    if (objectHandle == reinterpret_cast<jlong>(runtime->globalObject)) {
        object = context->Global();
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1add__JJLjava_lang_String_2I(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jint value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Int32::New(isolate, value));
}


JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addObject(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jlong valueHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1add__JJLjava_lang_String_2Z(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jboolean value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Boolean::New(isolate, value));
}


JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1add__JJLjava_lang_String_2D(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jdouble value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Number::New(isolate, value));
}


JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1add__JJLjava_lang_String_2Ljava_lang_String_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key, jstring value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addUndefined(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Undefined(isolate));
}


JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addNull(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    addValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key, Null(isolate));
}


JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1registerJavaMethod(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring functionName, jboolean voidMethod) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Array(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlongArray JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Function(JNIEnv *env, jobject, jlong v8RuntimePtr) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    MethodDescriptor* md = new MethodDescriptor();
    Local<External> ext = External::New(isolate, md);
    Persistent<External> pext(isolate, ext);
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetSize(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetInteger(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetBoolean(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_BOOLEAN(v8Value);
...
JNIEXPORT jbyte JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetByte(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, false);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_NUMBER(v8Value);
...
JNIEXPORT jdouble JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetDouble(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_NUMBER(v8Value);
...
JNIEXPORT jstring JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetString(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    Handle<Value> v8Value = array->Get(index);
    ASSERT_IS_STRING(v8Value);
...
JNIEXPORT jobject JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGet(JNIEnv *env, jobject v8, jlong v8RuntimePtr, jint expectedType, jlong arrayHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addArrayIntItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addArrayBooleanItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jboolean value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addArrayDoubleItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jdouble value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addArrayStringItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jstring value) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addArrayObjectItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jlong valueHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addArrayUndefinedItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1addArrayNullItem(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    if ( array->IsTypedArray() ) {
        Local<String> string = String::NewFromUtf8(isolate, "Cannot push to a Typed Array.");
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getType__JJLjava_lang_String_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jstring key) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Value> v8Value = getValueWithKey(env, isolate, v8RuntimePtr, objectHandle, key);
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getType__JJI(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jint index) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getArrayType(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
    int length = 0;
    if ( array->IsTypedArray() ) {
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1setPrototype(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jlong prototypeHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jstring JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getConstructorName(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> object = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(objectHandle));
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getType__JJ(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getType__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
    int result = -1;
    for (int i = start; i < start + length; i++) {
...
JNIEXPORT jdoubleArray JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetDoubles__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jintArray JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetIntegers__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jbooleanArray JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetBooleans__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jbyteArray JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetBytes__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetDoubles__JJIILdouble_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jdoubleArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetIntegers__JJIILint_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jintArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jobjectArray JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetStrings__JJII(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, NULL);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetBooleans__JJIILboolean_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jbooleanArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetBytes__JJIILbyte_3_093_2(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jbyteArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jint JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1arrayGetStrings__JJIILjava_lang_String_3_093_2(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong arrayHandle, jint start, jint length, jobjectArray result) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<Object> array = Local<Object>::New(isolate, *reinterpret_cast<Persistent<Object>*>(arrayHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8ArrayBuffer__JI(JNIEnv *env, jobject, jlong v8RuntimePtr, jint capacity) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8ArrayBuffer__JLjava_nio_ByteBuffer_2I(JNIEnv *env, jobject, jlong v8RuntimePtr, jobject byteBuffer, jint capacity) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Int32Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8UInt32Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Float32Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Float64Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Int16Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8UInt16Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8Int8Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8UInt8Array(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initNewV8UInt8ClampedArray(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong bufferHandle, jint offset, jint length) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    Handle<ArrayBuffer> arrayBuffer = Local<ArrayBuffer>::New(isolate, *reinterpret_cast<Persistent<ArrayBuffer>*>(bufferHandle));
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1setWeak(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1clearWeak(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, );
    reinterpret_cast<Persistent<Object>*>(objectHandle)->ClearWeak();
}


JNIEXPORT jboolean JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1isWeak(JNIEnv * env, jobject, jlong v8RuntimePtr, jlong objectHandle) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
    return reinterpret_cast<Persistent<Object>*>(objectHandle)->IsWeak();
}


JNIEXPORT jobject JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1createV8ArrayBufferBackingStore(JNIEnv *env, jobject, jlong v8RuntimePtr, jlong objectHandle, jint capacity) {
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jstring JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getVersion(JNIEnv *env, jclass){
    const char *utfstring = v8::V8::GetVersion();
    return env->NewStringUTF(utfstring);
}

JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1setFlags(JNIEnv *env, jclass, jstring v8flags){
    if (v8flags) {
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1terminateExecution(JNIEnv * env, jobject, jlong v8RuntimePtr) {
    if (v8RuntimePtr == 0) {
        return;
    }
    Isolate* isolate = getIsolate(env, v8RuntimePtr);
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getGlobalObject(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate* isolate = SETUP(env, v8RuntimePtr, 0);
...
JNIEXPORT jlong JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1getBuildID(JNIEnv *, jobject) {
    return 1;
}
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1connect(JNIEnv *env, jobject, jlong v8RuntimePtr, jobject connection){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
    piv8_inspector::getInstance()->connect(env,connection);
}


JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1disconnect(JNIEnv *env, jobject, jlong v8RuntimePtr){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
    piv8_inspector::getInstance()->disconnect(env,isolate);
}


JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1dispatchMessage(JNIEnv *env, jobject, jlong v8RuntimePtr,jstring message){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
...
JNIEXPORT void JNICALL Java_com_kuplay_pi_1framework_piv8_V8__1initDebugger(JNIEnv *env, jobject , jlong v8RuntimePtr){
    Isolate *isolate = SETUP(env,v8RuntimePtr,);
