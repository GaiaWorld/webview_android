...
import com.high.pi_framework.Util.WebViewUtil
import com.high.pi_framework.base.BaseActivity
import com.high.pi_framework.base.JSInterface
    ...
    fun destroyYnWebView(){
        ...
        if (isX5) {
            if (mX5 != null) {
                ...
                mX5!!.clearHistory()
                mX5!!.removeJavascriptInterface(JSBridge::class.java.simpleName)
                mX5!!.removeJavascriptInterface(JSIntercept::class.java.simpleName)
            }
        }
        else {
            if (mAndroidWebView != null) {
                ...
                mAndroidWebView!!.removeJavascriptInterface(JSBridge::class.java.simpleName)
                mAndroidWebView!!.removeJavascriptInterface(JSIntercept::class.java.simpleName)
            }
        }
    }
